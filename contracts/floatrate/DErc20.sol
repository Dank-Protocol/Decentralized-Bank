...
contract DErc20 is DToken, DErc20Interface {
    ...
    function liquidateBorrow(
        ...
        (uint256 err, ) =
            liquidateBorrowInternal(borrower, repayAmount, dTokenCollateral);
        return err;
    }
        ...
        returns (uint256)
    {
        ...
        assembly {
            switch returndatasize()
                ...
                case 32 {
                    // This is a dankliant ERC-20
                    returndatacopy(0, 0, 32)
                    success := mload(0) // Set `success = returndata` of external call
                }
                default {
                    // This is an excessively non-dankliant ERC-20, revert.
                    revert(0, 0)
                }
        }
