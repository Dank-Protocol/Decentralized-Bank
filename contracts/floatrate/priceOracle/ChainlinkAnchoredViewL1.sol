...
contract ChainlinkConfig {
    ...
    uint256 public constant maxTokens = 25;
    ...
    function getDTokenIndex(address dToken) internal view returns (uint256) {
        ...
        if (i == 0)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit00,
                    chainlinkMarket: chainlinkMarket00,
        ...
        if (i == 1)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit01,
                    chainlinkMarket: chainlinkMarket01,
        ...
        if (i == 2)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit02,
                    chainlinkMarket: chainlinkMarket02,
        ...
        if (i == 3)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit03,
                    chainlinkMarket: chainlinkMarket03,
        ...
        if (i == 4)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit04,
                    chainlinkMarket: chainlinkMarket04,
        ...
        if (i == 5)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit05,
                    chainlinkMarket: chainlinkMarket05,
        ...
        if (i == 6)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit06,
                    chainlinkMarket: chainlinkMarket06,
        ...
        if (i == 7)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit07,
                    chainlinkMarket: chainlinkMarket07,
        ...
        if (i == 8)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit08,
                    chainlinkMarket: chainlinkMarket08,
        ...
        if (i == 9)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit09,
                    chainlinkMarket: chainlinkMarket09,
        ...
        if (i == 10)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit10,
                    chainlinkMarket: chainlinkMarket10,
        ...
        if (i == 11)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit11,
                    chainlinkMarket: chainlinkMarket11,
        ...
        if (i == 12)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit12,
                    chainlinkMarket: chainlinkMarket12,
        ...
        if (i == 13)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit13,
                    chainlinkMarket: chainlinkMarket13,
        ...
        if (i == 14)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit14,
                    chainlinkMarket: chainlinkMarket14,
        ...
        if (i == 15)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit15,
                    chainlinkMarket: chainlinkMarket15,
        ...
        if (i == 16)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit16,
                    chainlinkMarket: chainlinkMarket16,
        ...
        if (i == 17)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit17,
                    chainlinkMarket: chainlinkMarket17,
        ...
        if (i == 18)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit18,
                    chainlinkMarket: chainlinkMarket18,
        ...
        if (i == 19)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit19,
                    chainlinkMarket: chainlinkMarket19,
        ...
        if (i == 20)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit20,
                    chainlinkMarket: chainlinkMarket20,
        ...
        if (i == 21)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit21,
                    chainlinkMarket: chainlinkMarket21,
        ...
        if (i == 22)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit22,
                    chainlinkMarket: chainlinkMarket22,
        ...
        if (i == 23)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit23,
                    chainlinkMarket: chainlinkMarket23,
        ...
        if (i == 24)
            return
                TokenConfig({
                    ...
                    baseUnit: baseUnit24,
                    chainlinkMarket: chainlinkMarket24,
    ...
    function getHashBySymbol(string memory symbol)
        public
        view
        returns (bytes32)
    {
     ...
     * @return The config object
     */
    function getTokenConfigByDToken(address dToken)
        public
        view
        returns (TokenConfig memory)
    {
        uint256 index = getDTokenIndex(dToken);
        if (index != uint256(-1)) {
            return getTokenConfig(index);
        }
...
contract ChainlinkAnchoredViewL1 is ChainlinkConfig, Ownable {
     ...
     */
    constructor(TokenConfig[] memory configs) public ChainlinkConfig(configs) {
     ...
     */
    function getUnderlyingPrice(address dToken)
        external
        view
        returns (uint256)
    {
    ...
    function convertReportedPrice(
        ...
        if (config.reporterMultiplier > 10**6) {
            convertedPrice =
                unsignedPrice /
                (config.reporterMultiplier / 10**6);
        } else if (config.reporterMultiplier < 10**6) {
            convertedPrice =
                unsignedPrice *
                (10**6 / config.reporterMultiplier);
        }
