    ...
    DDelegatorInterface
{
    ...
    function _setImplementation(
        ...
        require(
            msg.sender == admin,
            "DErc20Delegator::_setImplementation: Caller must be admin"
        );
    ...
    function liquidateBorrow(
        address borrower,
        uint256 repayAmount,
        DTokenInterface cTokenCollateral
    ...
    function() external payable {
        require(
            msg.value == 0,
            "DErc20Delegator:fallback: cannot send value to fallback"
        );
